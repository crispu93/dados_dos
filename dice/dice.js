...
(function(dice) {
    ...
    this.standart_d20_dice_face_labels1 = [' ', '0', '2', '3', '6', '6', '9', '9'];
    this.standart_d20_dice_face_labels2 = [' ', '0', '1', '4', '5', '5', '10', '10'];
    ...
    this.known_types = ['d1', 'd2'];
    this.dice_face_range = { 'd1': [1, 4], 'd2': [1, 6], 'd3': [1, 8], 'd10': [0, 9], 
        'd12': [1, 12], 'd20': [1, 20], 'd100': [0, 9] };
    this.dice_mass = { 'd1': 300, 'd2': 300, 'd3': 340, 'd10': 350, 'd12': 350, 'd20': 400, 'd100': 350 };
    this.dice_inertia = { 'd1': 5, 'd2': 13, 'd3': 10, 'd10': 9, 'd12': 8, 'd20': 6, 'd100': 9 };
    ...
    this.dice_box.prototype.draw_selector = function() {
        ...
        for (var i = 0, pos = -1; i < that.known_types.length; ++i, pos+=2) {
